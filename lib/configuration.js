(function() {
  ...
  module.exports = Configuration = (function() {
    ...
    function Configuration(options) {
      ...
      this.hostRoot = (_ref20 = (_ref21 = options.hostRoot) != null ? _ref21 : env.POW_HOST_ROOT) != null ? _ref20 : libraryPath(".pow_aplication", "Hosts");
  ...
  libraryPath = function() {
    ...
    return path.join.apply(path, [env.HOME].concat(__slice.call(args)));
  };
